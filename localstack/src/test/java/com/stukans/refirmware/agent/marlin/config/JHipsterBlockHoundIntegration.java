...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.stukans.refirmware.agent.marlin.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "com.stukans.refirmware.agent.marlin.security.DomainUserDetailsService",
